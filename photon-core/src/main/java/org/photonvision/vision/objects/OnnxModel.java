...
/** Model descriptor for ONNX-based object detectors. */
public class OnnxModel implements Model {
    public final File modelFile;
    public final ModelProperties properties;

    public OnnxModel(ModelProperties properties) {
    ...
    public ObjectDetector load() {
        Size inputSize = new Size(properties.resolutionWidth(), properties.resolutionHeight());
        return new OnnxObjectDetector(this, inputSize);
    }
